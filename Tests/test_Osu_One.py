...
class OsuAutomationOne(unittest.TestCase):
    ...
    def test_google(self):
        ...
        Actions.login_user_one(self)
        Actions.choose_category(self)

        Actions.run_script(self, 1, 3)
    ...
    def tearDownClass(self):
        ...
        print("Test One, number of downloaded beatmapsets: %s" % len(OsuAutomationOne.downloaded_beatmapsets))
